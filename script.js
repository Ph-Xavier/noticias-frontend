...
const API_URL = "https://noticias-backend-397t.onrender.com";
...
async function criarNoticia() {
  ...
  if (!titulo || !descricao) {
    mensagem.innerHTML =
      '<div class="error">❌ Título e descrição são obrigatórios!</div>';
    return;
  }
  ...
  try {
    ...
    mensagem.innerHTML =
      '<div class="success">✅ Notícia criada com sucesso!</div>';
